...
#if __CYGWIN__ || defined(__MINGW32__)
#define DECLARE_SWIFT_SECTION(name)                                            \
  __attribute__((section("." #name "$A"))) static uintptr_t __start_##name = 0; \
  __attribute__((section("." #name "$C"))) static uintptr_t __stop_##name = 0;
#else
#define DECLARE_SWIFT_SECTION(name)                                            \
